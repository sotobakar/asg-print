                    ...
                    <form class="space-y-6" action={{ route('customer.register') }} method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex">
                                ...
                                <label for="agreement" class="ml-2 block text-sm text-gray-900">Mendaftar berarti Anda
                                    setuju kami menyimpan data pribadi yang diberikan di form ini. Kami tidak akan
                                    menyebarkan data Anda ke pihak lain.</label>
                            </div>
                        </div>
