    ...
    <div class="flex min-h-full flex-col bg-white pt-16 pb-12">
        <div class="mx-auto w-[800px]">
            ...
            <form class="mt-8 flex flex-col gap-y-4" action="{{ route('customer.design') }}" method="POST"
                    ...
                    <div class="w-1/2">
                        ...
                        <div class="mt-1">
                            <select name="jenis_produk" id="jenis_produk"
                                ...
                                <option value="t-shirt">Kaos/T-Shirt</option>
                ...
                <div class="flex gap-x-4">
                    <div class="w-1/2">
                        <label for="desain_depan" class="block text-sm font-medium text-gray-700">Desain bagian depan</label>
                        <div class="mt-1">
                    ...
                    <div class="w-1/2">
                        <label for="desain_belakang" class="block text-sm font-medium text-gray-700">Desain bagian belakang</label>
                        <div class="mt-1">
