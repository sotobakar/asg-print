            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6">
                <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
                    ...
                    <nav class="hidden space-x-10 md:flex">
                        ...
                        <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Keranjang</a>
                        <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Custom
                            Sablon</a>
                    </nav>
