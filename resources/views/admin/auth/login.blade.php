...
@section('content')
    <main class="h-screen lg:relative bg-contain bg-repeat" style="background-image: url('{{ url('assets/images/bg.jpg') }}')">
        <!--
        ...
        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <img class="mx-auto h-12 w-auto" src={{ url('assets/images/logo.png') }}
                    alt="Your Company">
                <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Admin Portal</h2>
            </div>

            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                @if ($errors->any())
                <div class="mb-4 sm:w-full sm:max-w-xl rounded-md bg-red-50 p-4">
                    <div class="flex">
                ...
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <form action="{{ route('admin.login') }}" class="space-y-6" method="POST">
                        @csrf
                        <div>
