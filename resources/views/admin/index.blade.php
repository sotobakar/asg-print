            ...
            <div>
                ...
                <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-5 shadow sm:px-6 sm:pt-6">
                        <dt>
                            <div class="absolute rounded-md bg-indigo-500 p-3">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-6 w-6 text-white" fill="currentColor">
                                    <path
                    ...
                    <div class="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-5 shadow sm:px-6 sm:pt-6">
                        ...
                        <dd class="ml-16 flex items-baseline pb-2 sm:pb-3">
                            <p class="text-2xl font-semibold text-gray-900">Rp. {{ number_format($statistics['revenue_total'], 0, ',', '.') }}</p>
                        </dd>
                    </div>
